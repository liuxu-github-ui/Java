...
public class CommonWords
{
    public String[] getCommon(){
        //Add by lx: put all the 20 words from common.txt into an array called common
	...
	public void countWords(FileResource resource, String[] common, int[] counts){
	    //lx: count how many words in the file. If the word appear in the common array, add count+1
	...
	void countShakespeare(){
		...
		for(int k=0; k < plays.length; k++){
		    //lx: read each of the text file(text file name put in an array plays
